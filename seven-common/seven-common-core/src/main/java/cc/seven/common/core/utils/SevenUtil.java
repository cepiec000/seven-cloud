package cc.seven.common.core.utils;

import cc.seven.common.core.constant.PageConstant;
import cc.seven.common.core.entity.admin.CurrentUser;
...
public class SevenUtil {
     ...
     * @return String IP
     */
    public static String getServerHttpRequestIpAddress(HttpHeaders headers, InetSocketAddress address) {
        ...
        if (ip == null || ip.length() == 0 || UNKNOW.equalsIgnoreCase(ip)) {
            ip = Objects.requireNonNull(address).getAddress().getHostAddress();
        }
        return "0:0:0:0:0:0:0:1".equals(ip) ? "127.0.0.1" : ip;
    }
    ...
    public static String getCurrentUsername() {
        ...
        if (principal instanceof SevenAuthUser) {
            return ((SevenAuthUser) principal).getUsername();
        }
    ...
    public static String getCurrentTokenValue() {
        OAuth2Authentication auth2Authentication= getOauth2Authentication();
