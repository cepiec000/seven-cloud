package cc.seven.auth.filter;

import cc.seven.auth.service.ValidateCodeService;
import cc.seven.common.core.constant.EndpointConstant;
    ...
    protected void doFilterInternal(@Nonnull HttpServletRequest httpServletRequest, @Nonnull HttpServletResponse httpServletResponse,
        ...
        if (matcher.matches(httpServletRequest)
            ...
            try {
                ...
                SevenUtil.makeResponse(httpServletResponse, MediaType.APPLICATION_JSON_VALUE,
                        HttpServletResponse.SC_INTERNAL_SERVER_ERROR, ApiResult.fail(e.getMessage()));
