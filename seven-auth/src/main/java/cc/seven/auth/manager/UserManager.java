package cc.seven.auth.manager;

import cc.seven.auth.mapper.MenuMapper;
import cc.seven.auth.mapper.UserMapper;
import cc.seven.auth.mapper.UserRoleMapper;
...
import cc.seven.common.core.entity.admin.UserRole;
...
public class UserManager {
    ...
    public SystemUser registUser(String username, String password) {
        ...
        // 注册用户角色 ID
        userRole.setRoleId(SevenConstant.REGISTER_ROLE_ID);
