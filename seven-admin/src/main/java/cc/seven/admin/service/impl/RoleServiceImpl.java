...
import cc.seven.admin.entity.RoleMenu;
import cc.seven.admin.mapper.RoleMapper;
import cc.seven.admin.service.IRoleMenuService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements IRoleService {
    ...
    public IPage<Role> findRoles(Role role, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "createTime", SevenConstant.ORDER_DESC, false);
