...
import cc.seven.admin.mapper.LoginLogMapper;
import cc.seven.admin.service.ILoginLogService;
import cc.seven.admin.utils.AddressUtil;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", SevenConstant.ORDER_DESC, true);
