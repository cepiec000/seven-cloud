...
import cc.seven.admin.entity.DeptTree;
...
import cc.seven.admin.mapper.DeptMapper;
...
import cc.seven.common.core.utils.TreeUtil;
...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements IDeptService {
    ...
    public List<Dept> findDepts(Dept dept, QueryRequest request) {
        ...
        SortUtil.handleWrapperSort(request, queryWrapper, "orderNum", SevenConstant.ORDER_ASC, true);
