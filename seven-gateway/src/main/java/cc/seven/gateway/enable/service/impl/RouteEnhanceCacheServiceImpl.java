...
import cc.seven.gateway.enable.entity.BlackList;
import cc.seven.gateway.enable.entity.RateLimitRule;
import cc.seven.gateway.enable.service.RouteEnhanceCacheService;
import cc.seven.gateway.utils.RouteEnhanceCacheUtil;
...
public class RouteEnhanceCacheServiceImpl implements RouteEnhanceCacheService {
    private static final Logger log=LoggerFactory.getLogger(RouteEnhanceCacheServiceImpl.class);
