package cc.seven.gateway.common.handler;
 ...
 * @Version V1.0
 **/
public class SevenGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {
    private static Logger logger=LoggerFactory.getLogger(SevenGatewayExceptionHandler.class);
    public SevenGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties, ErrorProperties errorProperties, ApplicationContext applicationContext) {
